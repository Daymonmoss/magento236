...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'Daymonmoss_DuplicateEntry' => 1,
        'Daymonmoss_Landing' => 1,
        ...
        'MSP_TwoFactorAuth' => 1,
        'Overdose_LessonOne' => 1,
        'Overdose_Attributes' => 1,
        'Overdose_Crud' => 1,
        'Overdose_Custom' => 1,
        'Overdose_CustomShipping' => 1,
        'Overdose_CustomersLogger' => 1,
        'Overdose_Employee' => 1,
        'Overdose_AdminPanel' => 1,
        'Overdose_Plug' => 1,
        'Overdose_Widget' => 1,
